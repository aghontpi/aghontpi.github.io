...
_Blog.changeTitle=function(){var currentTitle=document.title;window.onblur=function(){document.title='Don\'t leave me!（＞﹏＜）';}
...
let modestring="extra "
isDark?(modestring+="extra-moon"):(modestring+="extra-cloud-sun")
$('a.theme-switch i.extra').each((i,e)=>{$(e).removeAttr('class').attr('class',modestring)})
$('body').toggleClass('dark-theme',isDark)
$('.theme-switch').on('click',()=>{$('body').toggleClass('dark-theme')
window.localStorage&&window.localStorage.setItem('theme',document.body.classList.contains('dark-theme')?'dark':'light',)
let modestring="extra "
document.body.classList.contains('dark-theme')?(modestring+="extra-moon"):(modestring+="extra-cloud-sun")
$('a.theme-switch i.extra').each((i,e)=>{$(e).removeAttr('class').attr('class',modestring)})})}
